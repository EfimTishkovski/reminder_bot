...
async def welcome(message:types.Message):
    ...
    btn_cancel = types.KeyboardButton('Отмена')                    # Кнопка отмены
    btn_start = types.KeyboardButton('/start')                     # Кнопка перезапуска
    btn_settings = types.KeyboardButton('/settings')               # Запуск настроек
    ...
    markup.row(btn_cancel, btn_start, btn_settings)       # добавление кнопок в третий ряд
